...
export default function Settings() {
  ...
  // ✅ حل المشكلة: تحديد نوع value بـ string | boolean بدلًا من any
  const updateSettings = async (key: string, value: string | boolean) => {
    if (user) {
    ...
    <div className={`min-h-screen p-6 ${darkMode ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"}`}>
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full bg-gray-800 text-white p-3 rounded-lg hover:bg-gray-600 transition"
        >
        ...
        <button
          ...
          className="w-full bg-green-600 text-white p-3 rounded-lg hover:bg-green-800 transition"
        >
          إعدادات الخصوصية
        </button>
        ...
        <button
          ...
          className="w-full bg-red-600 text-white p-3 rounded-lg hover:bg-red-800 transition"
        >
